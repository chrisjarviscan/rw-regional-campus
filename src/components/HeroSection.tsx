      ...
      <div className="container mx-auto max-w-7xl text-center relative z-10 px-4 py-20 md:py-28">
        ...
        >
          <span className="inline-block bg-hero-orange/15 text-primary-foreground border border-hero-orange/30 text-xs font-bold uppercase tracking-[0.15em] px-4 py-1.5 rounded-sm mb-6">
            2026–2027 REGIONAL CAMPUSES - WASHINGTON D.C. - ATLANTA - SEATTLE - BAY AREA
          </span>
        </div>
        ...
        >
          <h1 className="text-primary-foreground font-bold leading-[1.0] mb-8">
            <span className="block text-hero-orange whitespace-nowrap tracking-tight text-[clamp(1.75rem,6.2vw,9.5rem)]">
